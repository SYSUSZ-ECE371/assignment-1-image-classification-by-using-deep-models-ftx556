...
data_transforms = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize([0.458, 0.415, 0.306],
                     [0.252, 0.224, 0.235])
...
# model = models.densenet121(pretrained=True)   This is the model of densenet121

# Freeze First 2 Layers(used in ResNet)
...
# This is the last fully connected layer of densenet121
